...
import ru.practicum.shareit.server.exeption.AlreadyExistsException;
...
@Service("ServerBookingService")
@RequiredArgsConstructor
@Slf4j
public class BookingService {
    /**
     * Описание данных методов можно найти в {@link BookingController }
     */
